...
// temp variable
int temp1,temp2,temp3,temp4,temp5,temp6,temp7,temp8,temp9,temp10,temp10,temp11,temp12,temp13,temp14,temp15,temp16,temp17,temp18;
//sms variable 
int sms1,sms2,sms3,sms4,sms5,sms6,sms7,sms8,sms9,sms10,sms11,sms12,sms13,sms14,sms15,sms16,sms17,sms18;
// mater 
int techer,master;
// message to send
...
void loop() { 
            if (rfid.PICC_IsNewCardPresent() && rfid.PICC_ReadCardSerial()) {
                ...
                if(rfid.uid.uidByte == techercard && master=1){
                  techer=1;
                  digitalWrite(LED_BUILTIN, HIGH);
                  delay(500);
                  digitalWrite(LED_BUILTIN, LOW);
    ...
    if (techer = 1){
        ...
        if(value1 = 0 && sms = 0){
         sim800l.write("AT+CMGS=\"" + recipientNumber + "\"\r\n"); // use the stored phone number
          delay(1000);
         ...
         // send sms to school 
          ...
          sim800l.write("AT+CMGS=\"" + schoolnumber + "\"\r\n"); // use the stored phone number
          delay(1000);
